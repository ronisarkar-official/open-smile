	...
	return (
		<header className="sticky top-0 z-[100] border-b-[length:var(--border-width)] border-black bg-background">
			<nav className="mx-auto flex min-h-18 w-full max-w-[1280px] items-center justify-between gap-5 px-5 py-3 sm:px-6">
				<Link
					href="/"
					className="shrink-0 focus-visible:outline-3 focus-visible:outline-offset-4"
				...
				<div className="hidden items-center gap-3 md:flex">
					{isPending ?
						<div
							role="status"
							className="h-11 w-28 animate-pulse border-[length:var(--border-width)] border-black rounded-lg bg-muted"
