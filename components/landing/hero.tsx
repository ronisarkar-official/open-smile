...
import { ArrowDown, ArrowUpRight, Coins, Flame, Lock, Zap } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { HeroFloatingCoins } from './hero-floating-coins';
			...
			<div className="relative z-10 mx-auto grid w-full max-w-7xl gap-12 px-5 py-12 sm:px-6 sm:py-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-16 lg:py-20">
				<div className="max-w-2xl">
					...
					<p className="reveal-in reveal-delay-2 mt-5 max-w-[50ch] text-base leading-relaxed text-muted-foreground sm:text-lg">
						Turn a genuine daily grin into instant coins, unlock streak
						multipliers, and cash out for real gift cards. 100% on-device AI —
						your camera feed never leaves your phone or browser.
					</p>
					...
					<div className="reveal-in reveal-delay-3 mt-10 flex flex-wrap gap-2 pt-2">
						...
						<span className="inline-flex items-center gap-1.5 rounded-md border-(length:--border-width) border-border bg-card px-2.5 py-1 text-xs font-bold text-muted-foreground shadow-brutal-xs">
							<Coins className="size-3.5 text-foreground" /> Amazon gift
							vouchers
						</span>
					</div>
				</div>
