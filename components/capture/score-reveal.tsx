...
export function ScoreReveal({ score, className }: ScoreRevealProps) {
	...
	return (
		<motion.article
			...
			className={cn(
				'border-(length:--border-width) border-border rounded-xl bg-primary text-primary-foreground p-5 shadow-brutal-xl',
				className
			)}>
			...
			<div className="mt-4 h-3 w-full border-(length:--border-width-sm) border-border rounded-xs bg-card overflow-hidden">
				<motion.div
