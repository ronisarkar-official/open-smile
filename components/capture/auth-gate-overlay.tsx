	...
	return (
		<motion.div
			...
			<motion.div
				...
				className="relative z-10 flex w-full max-w-sm flex-col items-center gap-4 border-(length:--border-width-lg) border-border rounded-2xl bg-card p-6 shadow-brutal-xl text-center">
				{onClose && (
					<button
						type="button"
						onClick={onClose}
						className="absolute -top-3 -right-3 flex size-8 items-center justify-center border-(length:--border-width) border-border rounded-lg bg-background font-bold shadow-brutal transition-all hover:bg-muted active:translate-x-0.5 active:translate-y-0.5 active:shadow-none"
						aria-label="Close">
				...
				<div className="relative">
					<div className="flex size-16 items-center justify-center border-(length:--border-width) border-border rounded-2xl bg-warning text-warning-foreground shadow-brutal">
						<Coins className="size-9" strokeWidth={2.5} />
					</div>
					<div className="absolute -top-2 -right-2 flex size-6 items-center justify-center border-(length:--border-width-sm) border-border rounded-full bg-accent text-accent-foreground shadow-brutal-xs animate-bounce">
				...
				<div className="flex flex-col gap-2.5 w-full pt-1">
					<Button asChild size="lg" className="w-full gap-2 font-mono text-sm font-black uppercase tracking-wider bg-warning text-warning-foreground hover:bg-warning/90 border-(length:--border-width) border-border shadow-brutal brutal-lift">
