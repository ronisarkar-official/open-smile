...
const ECONOMY_NUMBERS: SettingNumberConfig[] = [
	...
	},
	{
		...
		label: "Referrer Scratch Card Max Coins",
		description: "Maximum hidden coins inside the Mystery Scratch Card awarded to the referrer.",
		defaultValue: 200,
		min: 10,
		max: 2000,
		step: 10,
	...
	},
	{
		...
		label: "Referrer Scratch Card Min Coins",
	...
	},
	{
		...
		label: "Friend Welcome Card Max Coins",
		description: "Maximum hidden coins inside the Welcome Scratch Card awarded to the newly referred friend.",
		defaultValue: 50,
		min: 10,
		max: 500,
		step: 5,
	...
	},
	{
		...
		label: "Friend Welcome Card Min Coins",
		description: "Guaranteed minimum coins inside the friend's Welcome Scratch Card.",
		defaultValue: 20,
		min: 5,
		max: 200,
		step: 5,
