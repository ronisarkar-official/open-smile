      ...
      <main id="main-content" className="flex-1 overflow-hidden">
        <section className="mx-auto grid w-full max-w-7xl gap-10 px-5 py-12 sm:px-6 sm:py-16 lg:grid-cols-[1.02fr_0.98fr] lg:items-center lg:gap-16 lg:py-24">
          <div className="max-w-2xl">
            <p className="reveal-in inline-flex border-[3px] border-black bg-secondary px-3 py-1 text-xs font-extrabold tracking-[0.12em] text-black uppercase">
          ...
          <div className="reveal-in reveal-delay-2 relative mx-auto w-full max-w-xl lg:max-w-none">
            <div className="absolute -left-5 -top-5 hidden h-16 w-16 border-[3px] border-black bg-secondary sm:block" />
            <div className="absolute -bottom-5 -right-5 hidden h-20 w-20 border-[3px] border-black bg-primary sm:block" />
            <div className="brutal-shadow-lg relative grid min-h-100 grid-cols-2 gap-3 border-[3px] border-black bg-accent p-3 sm:min-h-124 sm:gap-4 sm:p-4">
              <div className="col-span-2 flex items-center justify-between border-[3px] border-black bg-card px-4 py-3 sm:px-5">
                <div className="flex items-center gap-2 font-mono text-xs font-bold tracking-wider uppercase">
                  <span className="size-3 bg-secondary" /> Smile check
                </div>
                <span className="font-mono text-xs font-bold">LIVE</span>
              </div>
              <div className="relative col-span-2 flex min-h-52 flex-col items-center justify-center overflow-hidden border-[3px] border-black bg-primary p-6 sm:min-h-64">
                <div className="absolute left-5 top-5 h-5 w-5 border-[3px] border-black bg-secondary" />
                <div className="absolute bottom-5 right-5 h-7 w-7 border-[3px] border-black bg-accent" />
              ...
              <div className="flex flex-col justify-between border-[3px] border-black bg-card p-4 sm:p-5">
              ...
              <div className="flex flex-col justify-between border-[3px] border-black bg-secondary p-4 sm:p-5">
        ...
        <section id="how-it-works" className="border-y-[3px] border-black bg-card">
          <div className="mx-auto w-full max-w-7xl px-5 py-16 sm:px-6 lg:py-24">
            ...
            <ol className="mt-12 grid gap-6 lg:grid-cols-[1fr_1.15fr_0.9fr]">
              {steps.map((step, index) => {
                ...
                return (
                  <li key={step.number} className={`${step.color} brutal-surface brutal-lift flex min-h-72 flex-col p-6 sm:p-7 ${index === 1 ? "lg:-translate-y-5" : ""}`}>
                    ...
                    <div className="mt-auto">
                      ...
                      <p className="mt-3 max-w-[32ch] leading-7 text-black/75">{step.description}</p>
                    </div>
                  </li>
                );
              })}
        ...
        <section id="privacy" className="mx-auto grid w-full max-w-7xl gap-10 px-5 py-16 sm:px-6 lg:grid-cols-[1fr_0.95fr] lg:items-center lg:py-24">
          <div className="brutal-shadow-lg order-2 border-[3px] border-black bg-secondary p-5 sm:p-8 lg:order-1">
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="border-[3px] border-black bg-card p-5 sm:col-span-2">
                <LockKeyhole className="size-8" />
                <p className="mt-8 font-mono text-xs font-bold tracking-[0.12em] uppercase">Raw video stays with you</p>
              </div>
              <div className="border-[3px] border-black bg-primary p-5">
                <span className="block font-mono text-4xl font-black">01</span>
                <p className="mt-8 text-sm font-bold">On-device scoring</p>
              </div>
              <div className="border-[3px] border-black bg-accent p-5">
