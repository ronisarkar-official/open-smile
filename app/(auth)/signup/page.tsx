    ...
    <div className="space-y-2.5 sm:space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2">
        <Button
          type="button"
          variant="outline"
          className="w-full h-8 gap-1.5 text-xs font-bold border-[length:var(--border-width)] border-black shadow-brutal-xs hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 transition-all dark:border-white"
      ...
      <form onSubmit={handleSubmit} className="space-y-2">
        {error && (
          <div className="rounded border-[length:var(--border-width)] border-destructive bg-destructive/10 px-2.5 py-1.5 text-[11px] font-bold text-destructive shadow-brutal-xs">
            {error}
          </div>
        )}
        ...
        {/* Full Name */}
        <div className="space-y-0.5">
          <Label htmlFor="name" className="text-[10px] font-bold uppercase tracking-wider font-mono">
            Full name
          </Label>
          <div className="relative">
            ...
            <Input
              ...
              className="h-8 pl-8 text-xs border-[length:var(--border-width)] border-black dark:border-white rounded-md bg-background focus-visible:ring-1"
              value={name}
        ...
        {/* Email */}
        <div className="space-y-0.5">
          <Label htmlFor="email" className="text-[10px] font-bold uppercase tracking-wider font-mono">
            Email address
          </Label>
          <div className="relative">
        ...
        <div className="space-y-0.5">
          <div className="flex items-center justify-between">
            <Label htmlFor="password" className="text-[10px] font-bold uppercase tracking-wider font-mono">
              Password
            </Label>
            {password.length > 0 && (
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="h-8 pl-8 pr-8 text-xs border-[length:var(--border-width)] border-black dark:border-white rounded-md bg-background focus-visible:ring-1"
              value={password}
        ...
        {hasAutoRef || referralCode ? (
          <div className="flex items-center justify-between rounded border-[length:var(--border-width)] border-black bg-[#C6EED5] px-2.5 py-1 text-[10px] font-mono shadow-brutal-xs dark:border-white dark:bg-[#142A1D]">
            <div className="flex items-center gap-1.5">
              <Gift className="size-3 text-success shrink-0" />
              <span>
                Code: <strong className="text-foreground">{referralCode}</strong>
              </span>
            </div>
          ...
          <div>
            {!showReferralInput ? (
              ...
              <div className="space-y-0.5 animate-in fade-in-50">
                <Label htmlFor="referral" className="text-[10px] font-bold uppercase tracking-wider font-mono">
                  Referral code
                </Label>
                <Input
                  id="referral"
                  ...
                  className="h-7 text-[11px] font-mono uppercase border-[length:var(--border-width)] border-black dark:border-white rounded-md bg-background"
                  value={referralCode}
        ...
        <label className="flex items-start gap-2.5 pt-0.5 cursor-pointer select-none group">
          <div className="relative flex items-center justify-center shrink-0 mt-0.5">
            ...
            />
            <div className="size-[18px] rounded-[4px] border-[1px] border-black dark:border-white bg-card peer-checked:bg-primary transition-all flex items-center justify-center shadow-[1.5px_1.5px_0px_#000] dark:shadow-[1.5px_1.5px_0px_#fff]">
              {agreedToTerms && <Check className="size-3.5 stroke-[3.5] text-black" />}
            </div>
          </div>
        ...
        <Button
          type="submit"
          className="w-full h-8.5 gap-1.5 text-xs font-black uppercase tracking-wider border-[length:var(--border-width)] border-black bg-primary text-primary-foreground shadow-brutal-xs hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 active:translate-x-1 active:translate-y-1 transition-all dark:border-white"
          disabled={loading}
        >
          {loading ? (
            <>
